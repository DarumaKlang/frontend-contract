...
export const LOCALIZATION: Record<Language, Record<string, string>> = {
  th: {
    ...
    'step2-nav-title': 'รายละเอียดทรัพย์สิน & ค่าเช่า',
    'step2-nav-desc': 'ข้อมูลยูนิต ค่าเช่ารายเดือน และเงินประกัน',
    'step3-nav-title': 'การเข้าพัก & การชำระค่าเช่า',
    'step3-nav-desc': 'กำหนดวันเริ่มสัญญา เงินประกัน และเบี้ยปรับ',
  ...
  en: {
    ...
    'step2-nav-title': 'Property & Pricing',
    'step2-nav-desc': 'Specify property details, quantities and rent totals',
    'step3-nav-title': 'Move-In & Rent',
    'step3-nav-desc': 'Lease start date, deposit terms & late fees',
